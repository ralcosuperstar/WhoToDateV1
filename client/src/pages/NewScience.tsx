...
const FrameworkTabs = () => {
  ...
  const frameworkContent = {
    "big-five": {
      ...
      impact: "People who score high in Agreeableness and Conscientiousness tend to have more satisfying and stable relationships – they're cooperative, responsible, and easier to get along with. High Neuroticism (being prone to stress and mood swings) can lead to more conflict and insecurity.",
      stats: [
