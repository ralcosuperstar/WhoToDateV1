        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left mb-12 md:mb-0">
            ...
            <div>
              <Link 
                href="/register" 
                className="inline-flex items-center justify-center px-8 py-4 bg-primary text-gray-800 font-bold text-lg rounded-md shadow-md border border-primary/50 hover:bg-primary/90 transform hover:translate-y-[-2px] transition-all duration-300"
              >
                Take The Assessment
