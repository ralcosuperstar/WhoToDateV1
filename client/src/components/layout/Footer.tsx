        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/#compatibility-science" className="text-white/70 hover:text-white transition">The Science</Link></li>
              <li><Link href="/#testimonials" className="text-white/70 hover:text-white transition">Testimonials</Link></li>
              <li><Link href="/blog" className="text-white/70 hover:text-white transition">Blog</Link></li>
              <li><Link href="/help" className="text-white/70 hover:text-white transition">Help & Support</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/blog/understanding-compatibility-profile" className="text-white/70 hover:text-white transition">Compatibility Guide</Link></li>
              <li><Link href="/blog" className="text-white/70 hover:text-white transition">Relationship Tips</Link></li>
              <li><Link href="/blog/understanding-attachment-styles" className="text-white/70 hover:text-white transition">Understanding Attachment</Link></li>
              <li><Link href="/blog" className="text-white/70 hover:text-white transition">Personality Types</Link></li>
              <li><Link href="/blog" className="text-white/70 hover:text-white transition">Emotional Intelligence</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-white/70">123 Tech Park, Bengaluru<br/>Karnataka, India - 560001</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-6">
          <div className="flex flex-col md:flex-row md:justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <Link href="/sitemap" className="text-white/60 hover:text-white text-sm transition">Sitemap</Link>
            </div>
          </div>
        </div>
      </div>
