      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="hidden md:flex flex-wrap gap-2 mb-8 bg-white p-3 rounded-lg shadow-sm">
          <button 
            ...
            className={`px-4 py-2 rounded-full text-sm font-semibold ${activeSection === "overview" ? "bg-neutral-700 text-white shadow-md" : "bg-neutral-100 text-neutral-700 hover:bg-neutral-200"}`}
          >
            🔍 Overview
          </button>
          <button 
            ...
            <div className="absolute left-4 right-4 mt-1 bg-white rounded-lg shadow-lg overflow-hidden z-20">
              <div className="p-2 space-y-1">
                <button 
                  ...
                  className={`w-full text-left px-4 py-2 rounded-lg text-sm font-semibold ${activeSection === "overview" ? "bg-neutral-700 text-white shadow-md" : "bg-neutral-100 text-neutral-700 hover:bg-neutral-200"}`}
                >
                  🔍 Overview
                </button>
                <button 
